...
if($val[0]>"0"){
    ...
    <div class="modal-dialog">
		...
		$qryns="insert into payment_activity(Id,Amount_Activity,Code_Type,Id_Book)values(Id,'$tot','1','$_SESSION[idbook]');";		
if($conn->query($qryns)===TRUE){
}
...
if($valaaa[0]=="0"){
			$nssq="insert into payment_activity(Id,Amount_Activity,Code_Type,Id_Book)values(Id,'$_SESSION[PriceAct]','1','$_SESSION[idbook]');";		
if($conn->query($nssq)===TRUE){
}
