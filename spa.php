...
$qry="select * from activities where duration!=0;";
...
echo '<div class="column">
    <div class="card">
        <header>
  <p style="font-size:25px;">'.$row["Desc_Act"].'</p>
        </header>  
        <img src="'.$row["photo"].'">
   <p style="font-size:25px;">'.$row["Duration"].' Minute</p><p style="font-size:25px; color:blue;">'.$row["Price_Act"].'$ </p><footer><form method="POST" autocomplete="off">'
